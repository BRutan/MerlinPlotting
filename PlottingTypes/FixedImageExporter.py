##############################################################################
## FixedImageExporter.py
##############################################################################
## Description:
## * Fixed an issue with the ImageExporter class in the pyqtgraph library
## that is preventing output of png images.
...
__all__ = ['FixedImageExporter']

class FixedImageExporter(Exporter):
